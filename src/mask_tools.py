...
def circular_mask(nx=516,ny=1556,center_x=265,center_y=655,radius=30):
    '''
...
def beam_blocker_mask(nx=516,ny=1556,center_x=278,center_y=655,radius=30,slope=0.007,offset=-8,thickness=15):
    '''
